                ...
                <div class="accordion-group">
                    <div class="accordion-body collapse" id="collapseTwo">
                        <div class="accordion-inner">
                            ...
                            <form id="station-form" name="station-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/unit/create'  method="post">            
                             
                                <div class="row">
                                    <div class="col-xs-8">
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Unit name" />
                                    <input type="hidden" class="form-control" name="departmentID" id="departmentID" value="<?php echo $departmentID;?>" />
                                    <input type="hidden" class="form-control" name="departmentName" id="departmentName" value="<?php echo $departmentName;?>" />
                                        ...
                                        if (is_array($units) && count($units)) {
                                            foreach ($units as $loop) {                                             
                                                ...
                                                <tr id="<?php echo $id; ?>" class="edit_tr">
                                                    ...
                                                    <td class="center">
                                                      <a class="btn btn-danger" href="<?php echo base_url() . "index.php/unit/delete/" .$departmentID."/".$departmentName."/". $id; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
    ...
    $(document).ready(function ()
    {
        ...
        }).change(function ()
        {
            ...
            if (name.length > 0 )
            {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . "index.php/unit/update/"; ?>",
                    data: dataString,
                    cache: false,
