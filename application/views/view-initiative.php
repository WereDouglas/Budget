                ...
                <div class="accordion-group">
                    <div class="accordion-body collapse" id="collapseTwo">
                        <div class="accordion-inner">
                            ...
                            <form id="station-form" name="station-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/initiative/create'  method="post">            
                             
                                <div class="row">
                                    <div class="col-xs-8">
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" name="values" id="values" placeholder="Values" />
                                    <input type="hidden" class="form-control" name="objectiveID" id="objectiveID" value="<?php echo $objectiveID;?>" />
                                    <input type="hidden" class="form-control" name="objectiveName" id="objectiveName" value="<?php echo $objectiveName;?>" />
                            ...
                            <div class="box-content">
                                <table class="jobs table table-striped table-bordered bootstrap-datatable datatable" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        if (is_array($initiatives) && count($initiatives)) {
                                            foreach ($initiatives as $loop) {                                             
                                                $values = $loop->values;
                                                ...
                                                <tr id="<?php echo $id; ?>" class="edit_tr">
                                                    ...
                                                    <td class="edit_td">
                                                        <span id="values_<?php echo $id; ?>" class="text"><?php echo $values; ?></span>
                                                        <input type="text" value="<?php echo $values; ?>" class="editbox" id="values_input_<?php echo $id; ?>"
                                                    </td>
                                                    <td class="edit_td">
                                                    ...
                                                    <td class="center">
                                                      <a class="btn btn-danger" href="<?php echo base_url() . "index.php/initiative/delete/" .$objectiveID."/".$objectiveName."/". $id; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        {
            var ID = $(this).attr('id');
            var values = $("#values_input_" + ID).val();
            var details = $("#details_input_" + ID).val();
          


            var dataString = 'id=' + ID + '&values=' + values + '&details=' + details ;
            $("#values_" + ID).html('<img src="<?= base_url(); ?>images/loading.gif" />'); // Loading image
            ...
            if (values.length > 0 )
            {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . "index.php/initiative/update/"; ?>",
                    data: dataString,
                    cache: false,
                    success: function (html)
                    {
                        $("#values_" + ID).html(values);
