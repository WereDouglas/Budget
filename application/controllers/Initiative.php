...
class Initiative extends CI_Controller {
    ...
    public function index() {
         ...
         if($objectiveID==""){ $objectiveID=$this->session->userdata('objectiveID'); }
         if($objectiveName==""){$objectiveName=$this->session->userdata('objectiveName'); }
        ...
        if ($query) { $data['initiatives'] = $query;}       
